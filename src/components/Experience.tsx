    ...
    roles: [
      {
        ...
        bullets: [
          ...
          "Structured ticket ownership and acceptance criteria across internal and contractor Jira boards, establishing shared DoD standards that kept two concurrent workstreams unblocked and reduced cross-team clarification cycles.",
          ...
          "Owned program documentation across two pipelines — initiative context files, milestone plans, and ADRs — serving as the alignment layer for engineering and product; directly leveraged during contractor onboarding and two architectural pivots.",
        ],
      },
      {
